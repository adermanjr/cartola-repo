...
class PontuacaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update pontuacao" do
    patch pontuacao_url(@pontuacao), params: { pontuacao: { cartoleiro_id: @pontuacao.cartoleiro_id, pontos: @pontuacao.pontos, posicao: @pontuacao.posicao, rodada_id: @pontuacao.rodada_id } }
